...
col_pluma = "pluma"                # Anteriormente "pluma instalada"
col_alcance = "alcance deseado"
col_carga_deseada = "carga deseada"
col_modelo = "modelo de grua torre"
col_carga_punta = "carga punta pluma"  # Anteriormente "carga en punta"
...
# Slider para filtrar por la longitud de la pluma instalada (ahora "pluma")
...
# Slider para filtrar por la carga en punta mínima (ahora "carga punta pluma")
